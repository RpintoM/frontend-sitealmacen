...
@NgModule({
  ...
  imports: [
    BrowserModule,
    AppRoutingModule, // importamos para acceder a las rutas
    BrowserAnimationsModule,
    MenubarModule,
    FormsModule,
    ReactiveFormsModule,
    HttpClientModule, // importamos para hacer peticiones http
    TableModule,
    ButtonModule,
    ToastModule,
    InputTextModule,
  ...
  providers: [
    MessageService // importamos el servicio de mensajes de la api de primeng
  ],
